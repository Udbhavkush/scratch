...
class Value:
    ...
    we have created this class sort of an analogy for tensors. Just to manipulate the whole training process with some data structure.
    """
    ...
    def log(self):
        ...
        def _backward():
            self.grad += (1/x) * out.grad # local derivative * global derivative
        out._backward = _backward
        return out
    ...
    def sigmoid(self):
        ...
        def _backward():
            self.grad += t * (1 - t) * out.grad # local derivative * global derivative
        out._backward = _backward
